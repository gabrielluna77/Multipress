...
$ssql = "update orden_alt set cliente1='$nombre_cliente', proveedor1='$nombre_prov', impresoras1='$nom_impresora', descrip_proce1_A='$pro_ce1', descrip_proce1_B='$pro_ce2', descrip_proce1_C='$pro_ce3', descrip_proce1_D='$pro_ce4', cant_laminas1='$can_la', laminas_alm1='$lam_alm', tamano1='$lam_tamano', suaje_alm1='$ti_suajes'  Where folio_op = '$esta_foliado'";
...
<div class="contenedor">
   ...
   <div>
   <form  method="post" action="respuesta_producto2.php" class="cbp-mc-form">
