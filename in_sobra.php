...
<div class="barra-del-contenido">
     <div class="barra-lateral">
        <div></div>
        <div><a href="./agrega_sobra.php">Cargar Sobrantes al inventario</a></div>
  ...
  <div class="barra-de-trabajo">
     Filtrar la busqueda para localizar producto.
       <form method="post" action="load_sobra.php">
     ...
     <div class="container">
        ...
        <?php
            ...
            $sentencia = $base_de_datos ->query("SELECT count(*) AS conteo FROM sobrantes WHERE (clave > 0)");
            $conteo = $sentencia->fetchObject()->conteo;
            # Para obtener las páginas dividimos el conteo entre los productos por página, y redondeamos hacia arriba
            $paginas = ceil($conteo / $productosPorPagina);
            $sentencia = null;
            # Ahora obtenemos los productos usando ya el OFFSET y el LIMIT
            $sentencia = $base_de_datos->prepare("SELECT * FROM sobrantes WHERE (clave > 0 ) ORDER BY clave DESC LIMIT ? OFFSET ? ");
        ...
        <div class="col-xs-12">
            ...
            <td><?php echo $producto->tipo; ?></a></td>
            <td><?php echo $producto->canti;?></td>
            <td><?php echo $producto->ubica; ?></td>
            <td><?php echo $producto->fecha; ?></td>
            <td><?php echo $producto->comentar;?></td> 
            <td><?php echo $producto->salida;?></td>
            <td><a  href="<?php echo "editar_sobra.php?id=".$producto->clave;?>"> <img src="./imgmenu/logo_editar.png" alt="imagen editar" width="50" height="50" /></a></td>
           ...
           <?php if ($pagina > 1) { ?>
             <tr><td>
             <a href="./in_sobra.php?pagina=<?php echo $pagina - 1 ;?>">
             ...
             <div> <!-- inicia div normal -->
                ...
                <a href="./in_sobra.php?pagina=<?php echo $x; ?>">
                <?php echo $x; ?></a>
                </td>
                <?php } ?>
