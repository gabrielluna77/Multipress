...
<div class="contenedor">
        <div>
        <form  method="post" action="consulta_p.php" class="cbp-mc-form">
        <label for="bus_o">Folio de la orden:</label>
        
        </div>
        <div><input type="text" id="bus_o" size="20"    name="bus_o" placeholder="M12" ></div>
        <div></div>
        <div>
        <label for="no_a">Nombre del archivo:</label>
        
        </div>
		<div>
        <input type="text" id="no_a" size="60" name="no_a" placeholder="OP M127 cenefa 70x9+9 -frsxa fusion $27">
        </div>
