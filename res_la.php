...
<div class="barra-del-contenido">
     <div class="barra-lateral">
        <div></div>
        <div><a href="./agrega_la.php">Cargar láminas e insumos al inventario</a></div>
  ...
  <div class="barra-de-trabajo">
     ...
     <div class="container">
        ...
        <?php
            ...
            $sentencia = $base_de_datos ->query("SELECT count(*) AS conteo FROM laminas WHERE (clave > 0)");
            $conteo = $sentencia->fetchObject()->conteo;
            # Para obtener las páginas dividimos el conteo entre los productos por página, y redondeamos hacia arriba
            $paginas = ceil($conteo / $productosPorPagina);
            $sentencia = null;
            # Ahora obtenemos los productos usando ya el OFFSET y el LIMIT
            $sentencia = $base_de_datos->prepare("SELECT * FROM laminas WHERE (clave > 0 ) ORDER BY clave DESC LIMIT ? OFFSET ? ");
        ...
        <div class="col-xs-12">
            ...
            <td><?php echo $producto->producto ; ?></a></td>
            ...
            <td><a  href="<?php echo "editar_lam.php?id=".$producto->clave;?>"> <img src="./imgmenu/logo_editar.png" alt="imagen editar" width="50" height="50" /></a></td>
           ...
           <?php if ($pagina > 1) { ?>
             <tr><td>
             <a href="./res_la.php?pagina=<?php echo $pagina - 1 ;?>">
             ...
             <div> <!-- inicia div normal -->
                ...
                <a href="./res_la.php?pagina=<?php echo $x; ?>">
                <?php echo $x; ?></a>
                </td>
                <?php } ?>
