...
<div class="barra-del-contenido">
     <div class="barra-lateral">
        <div></div>
        <div><a href="./agrega_sua.php">Cargar Suajes al inventario</a></div>
  ...
  <div class="barra-de-trabajo">
     Filtrar la busqueda para localizar Suaje.
       <form method="post" action="load_sua.php">
     ...
     <div class="container">
        ...
        <?php
            ...
            $sentencia = $base_de_datos ->query("SELECT count(*) AS conteo FROM suajes WHERE (clave > 0)");
            ...
            $sentencia = $base_de_datos->prepare("SELECT * FROM suajes WHERE (clave > 0 ) ORDER BY clave DESC LIMIT ? OFFSET ? ");
        ...
        <div class="col-xs-12">
            ...
            <td><?php echo $producto->orden_suaje; ?></a></td>
            <td><?php echo $producto->ubica;?></td>
            <td><?php echo $producto->descrip; ?></td>
            <td><?php echo $producto->mov_s; ?></td>
            <td><?php echo $producto->impresor;?></td> 
            <td><?php echo $producto->op_utiliza;?></td> 
            <td><?php echo $producto->fecha_en;?></td> 
            <td><?php echo $producto->estado;?></td> 
            <td><a  href="<?php echo "editar_sua.php?id=".$producto->clave;?>"> <img src="./imgmenu/logo_editar.png" alt="imagen editar" width="50" height="50" /></a></td>
           ...
           <?php if ($pagina > 1) { ?>
             <tr><td>
             <a href="./in_sua.php?pagina=<?php echo $pagina - 1 ;?>">
            ...
            <td class="<?php if ($x == $pagina) echo "active"; ?>">
                <a href="./in_sua.php?pagina=<?php echo $x; ?>">
                <?php echo $x; ?></a>
                <?php } ?>
